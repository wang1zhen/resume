...
\begin{document}
\name{王\hspace{1em}一臻\\ \normalsize{オウ\hspace{1em}イシン\hspace{1.5em}WANG\hspace{1em}Yizhen}}
\tagline{東京大学\ 長谷川研究室\ 修士}
...
\cvevent{高校}{上海市実験学校}{2011.9 -- 2014.8}{中国\ 上海}

\divider

\cvevent{学部}{上海交通大学}{2014.9 -- 2018.9}{中国\ 上海}
\begin{itemize}
\item 機械と動力工学部、エネルギー・動力工学専攻
\item 人文学部 音楽学専攻（副専攻）
\end{itemize}
{\small\color{emphasis}{$\triangleright$ DMEおよびエタノールによるメタン火炎の希釈効果\\$\triangleright$ 水素冷却発電機の固定子基礎の動特性に関する研究}}

\divider

\cvevent{修士（中退）}{メルボーン大学}{2019.1 -- 2019.12}{オーストラリア\ メルボーン}
\begin{itemize}
\item 機械工学専攻
\end{itemize}
{\small\color{emphasis}{$\triangleright$ 粗面高レイノルズ数乱流境界層におけるエネルギー運動の解明}}

\divider

\cvevent{修士}{東京大学}{2023.10 -- 2025.9}{日本\ 東京}
\begin{itemize}
\item 機械工学専攻
\end{itemize}
{\small\color{emphasis}{$\triangleright$ 円管乱流実験における抵抗低減のための脈動波形の自動最適化}}

\cvsection{スキル}

{\Large\color{accent}{プログラミング}}

{\large\color{emphasis}\cvtag{Python} \cvtag{MATLAB} \cvtag{C\&C++} \cvtag{E-LISP}}

\divider

{\Large\color{accent}{3Dモデリング\&シミュレーション}}

{\large\color{emphasis}\cvtag{SolidWorks} \cvtag{OpenFOAM} \cvtag{ANSYS}}

\divider

{\Large\color{accent}{オフィスソフト}}

{\large\color{emphasis}\cvtag{Microsoft Office} \cvtag{\LaTeX}}

\divider

{\Large\color{accent}{ほか}}
...
\cvskill{英語（ビジネスレベル）}{4.5}
\divider

\cvskill{日本語（JLPT N2）}{4} %% Supports X.5 values.
...
\begin{itemize}
\item \color{accent}{クラシック音楽}

\color{emphasis}{アマチュアビオラ奏者}

\begin{center}
   \includegraphics[width=0.6\linewidth]{2.jpg}
\end{center}

\item \color{accent}{パソコンDIY}

\color{emphasis}{サーバー管理者}

\begin{center}
   \includegraphics[width=0.6\linewidth]{3.jpg}
\end{center}

\item \color{accent}{ネコ！}
